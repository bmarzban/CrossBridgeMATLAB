function [ dYdT, dSL, Ftotal ] = Model_XB( t,y,TmpC,MgATP,Pi,MgADP,F_load)
...
dfxb = heav(t-timrel)*(kstiff1*(- k3*(P3i + alpha3*(P3i*s3^2 + 2*P3w*s3)) ...
    + k1*(P1i - P1w*alpha1) - k_1*(P2i + P2w*alpha1)) - dr*kstiff2*(P3o*k_2 + k3*(P3o ...
    + alpha3*(P3o*s3^2 + 2*P3i*s3 + P3w)) - k2*((P2w*alpha2^2)/2 - P2i*alpha2 + P2o)));
