...
% adjvar = [0.5         0.4      0.4204         0.6      1.4422         0.6 1 1 ]
% 
%  adjvar = [1.4428     0.65237      2.6497      1.1895      2.6208     0.97297      3.5255      2.1805]
%  adjvar = [0.554376      7.01067      5.17166      1.59578      2.30039     0.856523      12.4149      8.91712]
% adjvar = [0.0675978      21.4669      25.8956      2.03282      2.82893      2.17447      30.7591      17.6528]
% adjvar =[0.00676      2.3346      2.5896     0.80945       2.286      2.2285           1           1]
% %k3stiff k2 and k1
...
figure(1)
legend( '0'    ,  '-0.5 um/s' , '-1 um/s'  ,        '-2 um/s'    ,    '-3 um/s'    ,      '-4um/s',    '-5 um/s'    )
% figure(2)
